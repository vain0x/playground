...
void add_person(avro_file_writer_t db, const char *first, const char *last,
...
int main(void)
{
	...
	rval = avro_file_writer_create_with_codec(dbname, person_schema, &db, QUICKSTOP_CODEC, 0);
	if (rval)
	{
